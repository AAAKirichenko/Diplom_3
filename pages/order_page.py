...
class OrderPage(BasePage):
    ...
    with allure.step('Получить общий счетчик заказов'):
    ...
    with allure.step('Получить счетчик заказов за сегодня'):
    ...
    with allure.step('Формирование динамического локатора'):
