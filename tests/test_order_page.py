...
class TestOrderPage:
    ...
    def test_total_counter_after_new_order_increase(self, driver):
    ...
    def test_today_counter_after_new_order_increase(self, driver):
        order_page = OrderPage(driver)
        main_page = MainPage(driver)
        account_page = AccountPage(driver)
    ...
    def test_number_order_in_progress_after_new_order(self, driver):
        order_page = OrderPage(driver)
        main_page = MainPage(driver)
        account_page = AccountPage(driver)
